...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent,launchGame);
            }
        });
        ...
        btnAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent,launchUserActivity);
            }
        });
    }
    private void createDatabase(){
        ...
        database.QueryData("CREATE TABLE IF NOT EXISTS Leaderboard(Id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                "Name VARCHAR(200), EasyScore INTEGER, MediumScore INTEGER, HardScore INTEGER)");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data != null){ // Tránh trường hợp chưa có data đã bấm về.
            if(requestCode == launchUserActivity){
